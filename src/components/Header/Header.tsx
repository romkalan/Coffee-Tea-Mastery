...
function Header() {
    ...
    return (
        <div className={classNames(styles.root)}>
            ...
            {isMobile ? (
                <>
                    <div className={classNames(styles.mobileNav)}>
                        <button
                        ...
                        <button onClick={handleLoginClick} className={classNames(styles.loginButton, isProfilePage && styles.loginButtonActive)}>
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/>
                                <circle cx="12" cy="7" r="4"/>
                            </svg>
                            <span>{user === null ? "Войти" : user.name}</span>
                        </button>
                    </div>
                    <MobileNav
