...
function SliderButtons({prevButton, nextButton, currentSlide, totalSlides}: SliderButtonsProps) {
    ...
    return (
        <div className={classNames(style.root)}>
            <button className={classNames(style.button)} onClick={prevButton}>
            ...
            <div className={classNames(style.pages)}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="12" cy="12" r="12" fill="#D2691E" fillOpacity={getDotOpacity(0)}/>
                </svg>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="12" cy="12" r="12" fill="#D2691E" fillOpacity={getDotOpacity(1)}/>
                </svg>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="12" cy="12" r="12" fill="#D2691E" fillOpacity={getDotOpacity(2)}/>
                </svg>
            </div>
            <button className={classNames(style.button)} onClick={nextButton}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
